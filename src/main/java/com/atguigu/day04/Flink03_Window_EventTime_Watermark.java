...
public class Flink03_Window_EventTime_Watermark {
    public static void main(String[] args) throws java.lang.Exception {
        ...
        SingleOutputStreamOperator<String> input
                = env.socketTextStream("hadoop102", 7777).assignTimestampsAndWatermarks(new BoundedOutOfOrdernessTimestampExtractor<String>(Time.seconds(2)) {
            @Override
            //提取时间戳
